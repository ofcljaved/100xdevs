...
export default function SignIn() {
  ...
  return (
    <Container>
      <View className="py-5">
        <Ionicons name="arrow-back" size={24} color="rgb(30 41 59)" onPress={handleBack} />
      </View>
      <View className="gap-10 p-5">
        <View className="gap-2">
          <View className="flex-row items-center gap-1">
            <Text className="text-2xl font-semibold text-slate-700">Welcome</Text>
            <Text className="text-2xl font-semibold text-[#4F46E5]">Dev!</Text>
            <Entypo name="code" size={20} color="#4F46E5" />
          </View>
          <Text className="text-slate-600">Sign in to explore your account</Text>
        </View>
        <View className="gap-4">
          ...
          <Pressable className="rounded-lg bg-blue-600 p-4" onPress={handleSubmit}>
